...
export default function ChatWindow({ selectedChat, messages, sending, onSendMessage, myTipo = "cliente" }) {
      ...
      <div className="chat-window">
        <div className="chat-empty">
          <div>
            ...
            <p style={{ fontWeight: 600, color: "var(--text-2)", marginBottom: 4 }}>
              Selecione uma conversa
            </p>
            <p style={{ fontSize: 13 }}>
              Escolha um vendedor na lista ao lado para começar.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="chat-window">
      ...
      <div className="chat-messages">
        ...
        {messages.map(m => (
          <MessageBubble key={m.id} message={m} myTipo={myTipo} />
        ))}
        <div ref={bottomRef} />
      </div>
